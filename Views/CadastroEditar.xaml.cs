...
public partial class CadastroEditar : ContentPage
{
	private CadastroSemaforico _cadastro;
    ...
    public CadastroEditar(CadastroSemaforico cadastro)
	{
		InitializeComponent();
        _cadastro = cadastro;
    ...
    {
        EntryRodovia.Text = _cadastro.Rodovia;
        PckDR.SelectedItem = _cadastro.Regional;
        PckSentido.SelectedItem = _cadastro.Sentido;
        PckLadoDaPista.SelectedItem = _cadastro.LadoPista;
        PckAtendimentoNorma.SelectedItem = _cadastro.AtendimentoNorma;
        EntryObsAN.Text = _cadastro.ObservacaoAN;
        EntryKM.Text = _cadastro.KM;
        PckDestinacao.SelectedItem = _cadastro.Destinacao;
        PckTipoSinalizacao.SelectedItem = _cadastro.TipoSinalizacao;
        PckForma.SelectedItem = _cadastro.FormaFoco;
        PckIndicacaoLuminosa.SelectedItem = _cadastro.IndicacaoLuminosa;
        PckSequencia.SelectedItem = _cadastro.SequenciaLuminosa;
        PckEstadoConservacao.SelectedItem = _cadastro.EstadoConservacao;
        EntryObsEC.Text = _cadastro.ObservacaoEC;
        EntryObs.Text = _cadastro.Observacao;
        EntryLatitude.Text = _cadastro.Latitude;
        EntryLongitude.Text = _cadastro.Longitude;
        _nomeFotoPanoramica = _cadastro.FotoPanoramica;
        _nomeFotoDetalhe1 = _cadastro.FotoDetalhe1;
        _nomeFotoDetalhe2 = _cadastro.FotoDetalhe2;
        _dateRegisterBegin = _cadastro.DataCadastro;
    }
